...
// assigns it: create.workflowLater is Workflows (F-WFL-*, M6); laterReasoning is
// visible thinking (F-CHT-08, M6); laterMemory is project memory (F-CHT-09, M6).
// The check reads the highest completed milestone from docs/STATUS.md and fails
